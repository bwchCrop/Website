...
// $base_url = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http"). "://". @$_SERVER['HTTP_HOST']; // DON'T TOUCH (base url (only domain) of site (without final /)).
$base_url = ''; // DON'T TOUCH (base url (only domain) of site (without final /)).

$uri_path = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
$uri_segments = explode('/', $uri_path);

$upload_dir = '/assets/img/'; //  HOSTING/LIVE<--path from base_url to base of upload folder (with start and final /) 
// $upload_dir = '/'.$uri_segments[1].'/assets/img/'; //  LOCALHOST<--path from base_url to base of upload folder (with start and final /) 
...
$access_keys = array('kamargelap11');
