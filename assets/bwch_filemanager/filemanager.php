...
//Application Title
define('APP_TITLE', 'Brawijaya Healthcare');
...
$auth_users = array(
    'admin' => password_hash('brawijayahealthcare2', PASSWORD_DEFAULT), //admin@123
...
$config_file = './assets/bwch_filemanager/config.php';
