...
<form class="mAdd" action="<?php echo base_url('add-doctor'); ?>" method="POST" enctype="multipart/form-data">
    <div class="row">
        <div class="col-md-9">
                ...
                <div class="box-body">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control toSlug" post="doctor"/>
                        </div>
                        <div class="form-group">
            ...
            <div class="box bottom-margin collapsed-box">
                ...
                <div class="box-body">
                    <div class="col-md-12 field-dimension" style="margin-bottom: 15px;">
                        <div class="form-group">
                            <textarea class="tinymce" id="spesification" name="spesification"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box bottom-margin collapsed-box">
                ...
                <div class="box-body">
                    <div class="col-md-12 field-dimension" style="margin-bottom: 15px;">
                        <div class="form-group">
                            <textarea class="tinymce" id="care" name="care"></textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box bottom-margin">
                <div class="box-header">
                    <h3 class="box-title">&nbsp;
                        &nbsp;&nbsp;
                        <!-- <a id="add-schedule" class="btn btn-primary add-schedule">--> Schedule <!--</a> -->
                ...
                <div class="box-body">
                    <div class="col-md-12 field-schedule">
                        <!-- <div class="input-group" style="margin-bottom: 5px;">
                            <input type="text" class="form-control" data-toggle="popover" data-trigger="hover focus" data-placement="top" title="Image" data-error=".result" id="schedule-1" name="schedule-1" >
                            <div class="input-group-btn">
                                <a class="btn btn-info iframe-btn" href="<?php echo base_url('assets/plugins/filemanager/dialog.php?type=2&amp;field_id=schedule-1&akey='._AKEY); ?>" class="iframe-btn" title="File Manager">
                                Browse
                                </a>
                            </div>
                        </div> -->
                        ...
                        <div class="form-group col-md-2">
                            ...
                            <div class="form-control-wrapper">
                                <input type="text" id="starttime" name="starttime" class="form-control time-picker start" placeholder="Start Time">
                            </div>
                        </div>
                        <div class="form-group col-md-2">
                            <label class="form-control-label">End Time</label>
                            <div class="form-control-wrapper">
                                <input type="text" id="endtime" name="endtime" class="form-control time-picker end" placeholder="End Time">
                            </div>
                        </div>
                        <div class="form-group col-md-1 no-padding-r">
                        ...
                        <table class="table table-bordered table-striped" id="example0">
                            ...
                            <tbody id="scheduleTemp">
                                <?php if(count($schedule_temp) > 0){ ?>
                                    <?php foreach($schedule_temp as $row){ ?>
                                        <tr>
                                            <td class="no-right" align="center">
                                                <a href="javascript:void(0);" class="close" onclick="deleteScheduleTemp('<?php echo $row['idindex'].'|'.$row['idschedule'];?>')"><i class="fa fa-close"></i></a>
                                            </td>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <label class="normal">
                            <input type="checkbox" id="highlight[]" name="highlight[]" class="minimal" value="<?php echo $row_high['highlight_id'];?>" />&nbsp;
                            <?php echo $row_high['highlight_title'];?>
                        </label><br>
                        <?php } ?>
                    </div>
                    <hr class="separator padding-bottom-15">                  
                    <div class="form-group">
                        <label>
                    ...
                    <div class="form-group">
                        <input class="form-control btn btn-primary" type="submit" id="btnsubmit" name="btnsubmit" value="Submit"/>
                    </div>
                </div>
            </div>      
        </div>
