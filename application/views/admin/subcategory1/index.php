<section class="content-header" style="padding:0;">
    <div class="box box-solid">
        <ol class="breadcrumb">
            ...
            <li>Category</li>
            <li class="active">Group Item Category</li>
        </ol>
    </div>
</section>
            ...
            <?php $no=0;
                ...
                <tr>
                    ...
                    <td align="center">
                        ...
                        &nbsp;
                        <a href="#" class="btn bg-purple btn-xs edit" data-id="groupitemcategory" pk="<?php echo $data['id']; ?>"  url1="view-groupitemcategory" url2="edit-groupitemcategory">
                            <i class="fa fa-edit"></i> Edit
                        </a>
                        &nbsp;
                        <a href="#" class="btn bg-maroon btn-xs delete" data-id="groupitemcategory" pk="<?php echo $data['id']; ?>" url="delete-groupitemcategory">
