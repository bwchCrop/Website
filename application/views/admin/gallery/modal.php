...
$(function() {
  ...
  $(".mAdd").validate({
    ...
    submitHandler: function(form) {
      ...
      // alert(path);
      $.post("<?php echo base_url('admin/gallery/action/option');?>",
  ...
  $(".mView").validate({
    ...
    submitHandler: function(form) {
      ...
      $.post("<?php echo base_url('admin/gallery/action/option/true/');?>"+file+'+'+ext,
  ...
  $(document).on('click','.closeMessage',function(e){
      ...
      if(urlext == ''){
        ...
        window.location.replace("<?php echo base_url('admin-gallery-index/');?>"+urlext);  
      }
  });
  ...
  $(document).on('click','.view',function(e){
    ...
    $.post('<?php echo base_url('admin/gallery/action/option/false/');?>'+file,
  ...
  $(document).on('click','.editor',function(e){
    ...
    $.post('<?php echo base_url('admin/gallery/action/filesrc/false/');?>',
  ...
  $(document).on('click','.photo',function(e){
    ...
    $.post('<?php echo base_url('admin/gallery/action/filesrc/photo');?>',
      {path:path,file:file},
      function(data){
        $('.overlay').hide();
        $('.modal-content img').hide();
  ...
  //   alert(files[0].name);
  //   $.post('<?php echo base_url('admin/gallery/action/upload');?>',
  //     {pathupload:path,name:name},
  //     function(data){
  //       $('.overlay').hide();
  //       if(data != ''){
  //         $("#successModal").modal('show');
  //         $("#successModal").find('.modal-body').text(data);
  //       }else{
  //         $("#successModal").modal('show');
  //         $("#successModal").find('.modal-body').text('Upload Failed..');
  //       }
  //     }   
  //   );
  // });
