          ...
          <tbody>
              ...
              <td align="left" style="background-color:#fff; padding: 10px; border-bottom: 1px solid #efefef;">
                <div align="left" style="width: 20%; float: left">
                  <a href="<?php echo base_url();?>" target="_blank">
                    <img style="width: 80px;" src="<?php echo base_url()._WEBLOGO;?>">
                  </a>
                </div>
                  ...
                  <tbody>
                    <tr>
                      <td height="36" width="540" valign="middle" class="titlecell">
                        <p class="signature" style="font-size: 12px;">Dear <?php echo $name;?>,<br/><br/></p>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="padding:5px">
                                <a href="<?php echo base_url();?>" target="_blank">
                                  <img style="width: 60px;" src="<?php echo base_url()._WEBLOGO;?>">
                                </a>
                              </td>
                              <td></td>
                            </tr>
            ...
            <tr>
              <td style="font-size:11px;line-height:16px;color:#aaa;padding:25px 40px" class="footerwrap">
                Please do not reply to this message; it was sent from an unmonitored email address.  This message is a service email related to your use of <?php echo _WEBTITLE;?> Web.  For general inquiries or to request support with your <?php echo _WEBTITLE;?> account, please visit us at 
                <a href="<?php echo base_url('contactus');?>" style="color:#6d90a9;text-decoration:none" target="_blank"><?php echo _WEBTITLE;?> Support</a>. 
              </td>
            </tr>
