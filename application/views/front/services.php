<section class="content container-fluid">
	...
	<div class="row container services ">
		<?php if($tab == '2'){$tab1='';$tab2='active';}else{$tab1='active';$tab2='';}?>

		<div class="tab-content">
			<div class="col-xs-12 no-pad tab-pane <?php echo $tab1;?>" role="tabpanel" id="servicestab" align="center">
				<?php if($type == 'main'){ ?>
				...
				<?php }else{ ?>
					...
					<div class="col-xs-12 content" align="left">
						<?php 
							if($tab == 1){
								$print = '';
			...
			<div class="col-xs-12 no-pad tab-pane <?php echo $tab2;?>" role="tabpanel" id="facilitiestab" align="center">
				<?php if($type == 'main'){ ?>
					<div class="col-xs-12 header">
						<div class="col-xs-12 no-pad header-title" align="center">
							<h1 class="italic purple">Facilities</h3>
						</div>
					</div>	
					<div class="col-xs-12 no-pad">
						<?php foreach($facilities as $row){ ?>
						<div class="col-sm-4 no-pad-left curs-point" onclick="loadDivPage('facilities','detail_facilities','<?php echo $row['post_id'];?>')">
							<div class="col-xs-12 service-list no-pad">
								<div class="container-image" align="center" style="padding-top: 37.5%;color: white;font-family: 'Quenda';font-size: 1.5em;/*font-family: 'Museo Sans 900';font-size: 1.25em;*/letter-spacing: 1px;">
									<b><?php echo strtoupper(str_replace(' (', '<br>(',$row['post_title']));?></b>
								</div>
