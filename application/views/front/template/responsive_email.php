          ...
          <tbody>
              ...
              <td align="left" style="background-color:#fff; padding: 10px; border-bottom: 1px solid #efefef;">
                <div align="left" style="width: 20%; float: left">
                  <a href="<?php echo base_url();?>" target="_blank">
                    <img style="width: 80px;" src="<?php echo 'http://ddf.app-show.net/brawijayahospital/'._WEBLOGO;?>">
                  </a>
                </div>
                <div align="right" style="width: 80%; float: left; font-family: 'Gotham'; padding-top: 15px;">
                  &nbsp;<?php echo $title;?>
                </div>
              </td>
            </tr>
                  ...
                  <tbody>
                    <tr>
                      <td height="36" width="540" valign="middle" class="titlecell">
                        ...
                        <p class="signature" style="font-size: 14px;">
                          <br/><br/>Sincerely,
                        </p>
                  ...
                  <tbody>
                    <tr>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td style="padding:5px">
                                <a href="<?php echo base_url();?>" target="_blank">
                                  <img style="width: 60px;" src="<?php echo 'http://ddf.app-show.net/brawijayahospital/'._WEBLOGO;?>">
                                </a>
                              </td>
                              <td></td>
                            </tr>
                      ...
                      <td valign="middle" style="width: 70%;padding:0 0 0 15px;font-size:10px;line-height:19px">
                        Jika butuh bantuan, gunakan halaman <a href="javascript:void(0);" target="_blank">kontak kami</a><br/>
                      ...
                      <td valign="middle" style="width: 20%;padding:0 0 0 15px;font-size:10px;line-height:19px">
                        ...
                        <!-- <a style="text-decoration: none" href="<?php echo _FB;?>" target="_blank">
                          <img style="width: 20%;" src="<?php echo base_url()._FBLOGO;?>">
                        </a>
                        <a style="text-decoration: none" href="<?php echo _TW;?>" target="_blank">
                          <img style="width: 20%;" src="<?php echo base_url()._TWLOGO;?>">
                        </a>
                        <a style="text-decoration: none" href="<?php echo _IG;?>" target="_blank">
                          <img style="width: 20%;" src="<?php echo base_url()._IGLOGO;?>">
                        </a> -->
                      </td>
                    </tr>
                  </tbody>
            ...
            <tr>
              <td style="font-size:11px;line-height:16px;color:#aaa;padding:25px 40px" class="footerwrap">
                Please do not reply to this message; it was sent from an unmonitored email address. This message is a service email related to your use of <?php echo _PT;?> Web.  For general inquiries or to request support with your <?php echo _PT;?> account, please visit us at 
                <a href="<?php echo base_url('contactus');?>" style="color:#6d90a9;text-decoration:none" target="_blank"><?php echo _PT;?> Support</a>. 
              </td>
            </tr>
