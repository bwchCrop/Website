          ...
          <div class="row">
            <div class="col-xs-6">
              ...
              <a href="<?php echo base_url(''); ?>">
                <img src="<?php echo base_url('assets/img/logo/logo_bw_transparent.png'); ?>" class="logo-size">
              </a>
            ...
            <div class="channel-button mobile-view">
              ...
              <div class="container-btn">
                <?php //if ($this->session->userdata(_PREFIX . 'frontlogin') == TRUE) { ?>
                  <a class="btn-circle italic ext hide" href="<?php //echo base_url('home/load_modalAccLogin/logout'); ?>" data-toggle="tooltip" data-placement="left" title="<?php //echo $this->session->userdata(_PREFIX . 'frontemail'); ?>"><?php //echo substr($this->session->userdata(_PREFIX . 'frontemail'), 0, 5); ?>... ,LOG OUT</a>
                <?php //} else { ?>
                  <?php //} ?>
            ...
            <ul class="nav navbar-nav nav-style" style="display: flex; justify-content: space-around;">
              ...
              <li class="main dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a href="<?php echo base_url('microsite/brawijayasaharjo'); ?>">Brawijaya Hospital Saharjo</a></li>
                  <li><a href="<?php echo base_url('microsite/brawijayahospitaltangerang'); ?>">Brawijaya Hospital Tangerang</a></li>
                </ul>
              </li>
