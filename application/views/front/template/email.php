		...
		<div id="container">
			<div id="header">
				<a href="<?php echo base_url();?>" target="_blank">
					<img src="<?php echo base_url()._WEBLOGO;?>">
				</a>
				<h1>&nbsp;<?php echo $title;?></h1>
			</div>
			<div id="body">
				<p class="signature">Dear Bpk/Ibu <?php echo $name;?>,<br/><br/></p>
				...
				<table width="100%">
					<tr>
						<td width="5%" rowspan="2">
							<a href="<?php echo base_url();?>" target="_blank">
								<img class="logo" src="<?php echo base_url()._WEBLOGO;?>">
							</a>			
						</td>
						<td>
						...
						<td width="30%" align="right">
							...
							<a href="<?php echo _FB;?>" target="_blank">
								<img class="socmed" src="<?php echo base_url()._FBLOGO;?>">
							</a>
							<a href="<?php echo _TW;?>" target="_blank">
								<img class="socmed" src="<?php echo base_url()._TWLOGO;?>">
							</a>
							<a href="<?php echo _IG;?>" target="_blank">
								<img class="socmed" src="<?php echo base_url()._IGLOGO;?>">
							</a>
						</td>
					</tr>
				</table>
