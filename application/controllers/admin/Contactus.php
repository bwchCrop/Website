...
class Contactus extends CI_Controller {
	...
	public function index(){
		...
		$data = array(
						'titlebar' 	=> 'Admin | Contact Us',
						'menu'		=> $this->mmenu->getParent()->result_array(),
						'content'	=> 'admin/contactus/index',
						'modal'  	=> 'admin/contactus/modal',
						'title'		=> 'Contact Us',
						'result'	=> $this->mcontactus->getAll()->result_array(),
	...
	function view(){
		...
		$get_data = $this->mcontactus->getByid($id)->row_array();
